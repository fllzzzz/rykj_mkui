<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="commentList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="评论内容" align="center" prop="contents" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="回复评论Id" prop="replyId">
          <el-input v-model="form.replyId" placeholder="请输入回复评论Id" />
        </el-form-item>
        <el-form-item label="评论内容" prop="contents">
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除文档评论编号为"' + ids + '"的数据项？').then(function() {
